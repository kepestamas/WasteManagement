...
**WasteManagement** is a data-driven simulation framework designed to model the complexities of urban waste management. By treating cities as dynamic ecosystems, this project provides a playground for testing "Demand-Driven" collection strategies against traditional "Static Route" schedules.
...
The project is structured into three distinct layers to ensure city-by-city adaptability:

### 1. The Geo-Ingestion Layer - WIP

### 2. The Simulation Engine - WIP

### 3. The Analytics Dashboard - WIP
